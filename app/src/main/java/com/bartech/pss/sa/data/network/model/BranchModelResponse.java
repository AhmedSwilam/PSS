...
public class BranchModelResponse implements Serializable
{
    ...
    @SerializedName("Data")
    @Expose
    private List<DatumBranch> data = null;
    ...
    private final static long serialVersionUID = 3968845299168211640L;
    ...
    public List<DatumBranch> getData() {
        return data;
    }

    public void setData(List<DatumBranch> data) {
        this.data = data;
    }
